...
model_ft, criterion, optimizer_ft, exp_lr_scheduler = model.build_model(model_name=new_model, model_path=config.training_load_dir, fc_flag=config.training_fc_flag, num_of_feature=6, optimizer=new_optimizer)
